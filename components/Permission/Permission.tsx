...
export const hasPermission = (permissions: string | string[], value: PermissionType): boolean => {
  const permission: string[] = Array.isArray(permissions) ? permissions : [permissions];
  if (!permission) {
    return false;
  }
