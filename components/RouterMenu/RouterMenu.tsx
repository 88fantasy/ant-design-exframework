...
import { Checkbox, Popover, Button, ConfigProvider } from 'antd';
...
const RouterMenu: React.FC<RouterMenuPropsType> = (props) => {
  ...
  const prefixCls = getPrefixCls('router-menu', '');

  const { menuData, itemClick, title = "菜单", showEdit = false,
    onSave, onCancel, className,
  } = props;
  ...
  const menuConetent = (
    <div className={classNames(routerMenuCls)}>
