...
// import { IDataItems, IHovs, Pager, IHovDatas } from '../Base/BaseService';
...
// export default class Module<T, U extends ParamsType> extends React.Component<
//   ModuleAllProps<T, U>
// > {
//   state = {
//     searchModal: false,
...
//   render() {
//     const {
//       proTableProps: { editable, rowKey, pagination },
//     } = this.props;
